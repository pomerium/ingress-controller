...
require (
	...
	github.com/pomerium/pomerium v0.32.5-rc.1.0.20260514221756-859ed6e4c884
...
require (
	...
	github.com/pomerium/envoy-custom v1.37.0-rc3.0.20260512225211-15289e9512f0 // indirect
