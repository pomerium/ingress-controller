...
require (
	...
	github.com/pomerium/pomerium v0.17.1-0.20220629143207-2ddd3953cd7a
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20220617124632-165a8c869c43
