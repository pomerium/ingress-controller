...
func (in *SSH) DeepCopyInto(out *SSH) {
	*out = *in
	if in.HostKeyFiles != nil {
		in, out := &in.HostKeyFiles, &out.HostKeyFiles
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
	...
	if in.UserCAKey != nil {
		in, out := &in.UserCAKey, &out.UserCAKey
		*out = new(string)
		**out = **in
	}
	if in.UserCAKeyFile != nil {
		in, out := &in.UserCAKeyFile, &out.UserCAKeyFile
		*out = new(string)
		**out = **in
	}
}
